...
class Form3_B implements ActionListener
                         ...
                         String ac=tf13.getText();
                                      ...
                                      PreparedStatement st;
                                            ...
                                            try
                                         {
                                           ...
                                           st=con.prepareStatement("insert into formIIIB values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                           st.setLong(1,id3);
                                           st.setString(2,bu);
                                           st.setString(3,ty);
                                           st.setString(4,add);
                                           ...
                                           st.setString(8,ip);
                                           st.setString(9,co1);
                                           st.setString(10,pno1);
                                           st.setString(11,co2);
                                           st.setString(12,pno2);
                                           st.setString(13,co3);
                                           st.setString(14,pno3);
                                           st.setString(15,co4);
                                           st.setString(16,pno4);
                                           st.setString(17,mar);
                                           st.setString(18,ac);
